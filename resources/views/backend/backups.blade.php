...
<div class="app-page-title">
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            ...
            document.getElementById('clean-old-backup-form').submit();" class="btn-shadow mr-3 btn btn-danger">
                    ...
                    <tbody>
                        @foreach ( $backups as $key => $backup)
                            ...
                            <td class="text-center">
                                ...
                                <button onclick="deleteData({{ $key }})" type="button" class="btn btn-danger btn-sm">
